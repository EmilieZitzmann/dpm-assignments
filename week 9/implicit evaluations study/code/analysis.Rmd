...
ggplot(data_processed_after_exclusions, aes(x= AMP_score)) + 
  geom_histogram(binwidth = .1, boundary= 0.05, fill = "gray", colour = "black") + theme_minimal() +
  xlab("AMP score") +
  ylab("Frequency")
...
#We have to be careful with the y and the x axis since the correlation is the same BUT the regression is not (since we have a UV and AV there). Jitter is really good for underplotting but you are not plotting the data --> adjust a geom point version so people can see what the true data looks right. 

#There are many nice color palets (virdis, you can also use those hexcodes --> just google it)
